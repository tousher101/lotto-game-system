...
export default function Layout({children}){
    ...
    return(
        <main className="max-w-[1380px] overflow-hidden flex  mx-auto">
            <aside className="flex-[20%]  bg-[#25343F] text-white h-screen">
                    ...
                    <Link href='/admindashboard/agentlist'><h1 className="mt-[10px] p-2 cursor-pointer hover:scale-105 duration-1000 ml-[15px] shadow-sm shadow-white">Agent List</h1></Link>
